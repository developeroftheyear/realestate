...
<div class="max-w-4xl mx-auto bg-white rounded-lg shadow p-6">
    ...
    <form action="{{ route('panel.agents.update', $agent->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end gap-4">
            <a href="{{ route('panel.agents.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded shadow hover:bg-gray-300 transition">Cancel</a>
